      ...
      >
        ...
        <div className="MenuFooter">
          ...
          {this.props.user.first_name ? (
            <React.Fragment>
              <div
                ...
                style={{ display: this.state.outTag ? "block" : "none" }}
              >
                LogOut
              </div>
              ...
              <div
                ...
                onMouseOver={(): void => this.setState({ outTag: true })}
                onMouseLeave={(): void => this.setState({ outTag: false })}
          ...
          {this.props.user.username === "" ? (
            <React.Fragment>
              <div
                className="MenuFooter__logIn__tag"
                style={{ display: this.state.inTag ? "block" : "none" }}
              >
                LogIn
              </div>
              <svg
                onMouseOver={(): void => this.setState({ inTag: true })}
                onMouseLeave={(): void => this.setState({ inTag: false })}
